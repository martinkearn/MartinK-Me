...
1. Open a Terminal in `/MartinKMe.Infrastructure`
1. `dotnet publish --no-restore --configuration Release --output ./publishfunctions ../MartinKMe.FunctionsV4/MartinKMe.FunctionsV4.csproj`
